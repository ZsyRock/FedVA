...
from .nets.cifar_10_cnn import Cifar10CNN
...
class Arguments:
    ...
    def __init__(self, logger):
        ...
        self.num_poisoned_workers = 30
        
        # data poison flow - concat for boosting
        self.data_poison = True
        self.poison_ratio = 0.2
        self.mal_strat = "concat"
        self.mal_boost = 1
        ...
        self.dataset_type = 'iid'

        self.data_distribution_strategy = "noniid" # or "noniid"

        self.noniid_alpha = 1.0 # Dirichlet distribution parameter
        self.target_class = 0  # 要计算目标类召回的类别编号
        self.source_class = None
        self.num_classes = 10  # 类别总数
    ...
    def get_data_distribution_strategy(self):
        return getattr(self, "data_distribution_strategy", "iid")

    def get_noniid_alpha(self):
        return self.noniid_alpha
    ...
    def log(self):
        ...
        self.logger.debug("Defence strategy: {}", self.defence)
        self.logger.debug("Model poison type: {}", self.model_poison)
        self.logger.debug("Sign scale: {}", self.sign_scale)
        self.logger.debug("Data poison flag: {}", self.data_poison)
        self.logger.debug("Non-IID alpha: {}", self.noniid_alpha)
    ...
    def __str__(self):
        return "\nBatch Size: {}\n".format(self.batch_size) + \
            ...
            "Data Distribution Strategy: {}\n".format(self.data_distribution_strategy) + \
            "Non-IID Alpha: {}\n".format(self.noniid_alpha)
